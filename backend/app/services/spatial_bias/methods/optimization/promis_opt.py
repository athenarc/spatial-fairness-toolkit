...
import numpy as np
from app.services.spatial_bias.utils.grb_utils import create_gurobi_model
...
def minimize_promis_opt_obj(
    ...
    model = create_gurobi_model(name="minimize_promis_opt", own_env=False)
...
def minimize_promis_opt_obj_overlap(
    ...
    model = create_gurobi_model(name="minimize_promis_opt_overlap", own_env=False)
